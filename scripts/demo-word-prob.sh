...
TEXT_DATA=$DATA_DIR/ptb_train
ZIPPED_TEXT_DATA="${TEXT_DATA}.zip"
VECTOR_DATA=$VEC_DIR/ptb_size10-10_epoch15.bin
...
-negative 0 -hs 1 -sample 1e-3 -threads 12 -binary 1 -report-period 0 -alpha 0.25 -eval ./eval-prob.sh -epoch 15
